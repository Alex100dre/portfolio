        ...
        <Paper overlapTop>
          ...
          <Content>
            ...
            <p>
              ...
              Mais ayant surtout connu la vie <abbr title="avant internet">ante-internet</abbr>, c'est après quelques années
              d'études superieur que je me suis lancé dans le <strong>développement web</strong>.
            </p>
            ...
            <p>
              ...
              le <strong>javascript</strong> via la stack <strong>react/redux/node</strong>...
            </p>

            <p>
              Fort de <strong>4 années d'experience</strong> en tant que <strong>développeur web</strong>, je suis
              actuellement en mission à la Société Générale pour le compte de BeNext en tant
              qu'<strong>ingénieur d'études</strong> alias <strong>développeur web fullstack JS</strong>.
            </p>

            <p>
              Vie professionelle mise à part, je suis un grand amateur de jeux vidéo, science-fiction, voyage, dessin, sport,
              actualité tech et spatiale, livre audio (#audible), culture nippone, mais aussi de drone et plus globalement de vidéo.<br />
              J'ai d'ailleurs, bien qu'étant novice dans le domaine, créé une chaine youtube dédié à cette dernière
              passion que vous pouvez consulter en <a href="https://www.youtube.com/channel/UCD2nU6-sTxDiacobzEtwyZw">cliquant ici</a>
            </p>
